...
ll n,q;
string s;
void func(ll i,string curr){
    if(i==n){
        subseqs.push_back(curr);
        return;
    }
    func(i+1,curr);
    curr.push_back(s[i]);
    ...
    while(t--){
      ...
      while(q--){
        ...
        if(x=='+'){
            ...
            cin>>no;
            if(no==1) if(s1.size()) s1.pop_back();
            else if(no==2) if(s2.size()) s2.pop_back();
            else if(s3.size()) s3.pop_back();
        }
        if(no==1){
            if(freq[s1]) cout<<"YES"<<nn;
            else cout<<"NO"<<nn;
        }
        else if(no==2){
             if(freq[s2]) cout<<"YES"<<nn;
            else cout<<"NO"<<nn;

        }
        else{
             if(freq[s3]) cout<<"YES"<<nn;
            else cout<<"NO"<<nn;
        }
      }
    }
